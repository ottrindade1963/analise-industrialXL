...
def executar_passo6():
    ...
    gerar_metadados(
        passo=6,
        descricao="Analise de estrategias, moderacao e performance de modelos",
        tempo_s=tempo_total,
        outputs=['correlacoes_wgi_target.csv', 'interacoes_wgi_wdi.csv', 
                 ...
                 'comparacao_rmse_modelos_datasets.png', 'ranking_modelos_r2.png']
    )
